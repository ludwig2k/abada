    ...
    <form action="{{route('vendedor.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div id="produtoFields">
            <div class="mt-4">
                ...
                <x-text-input id="nomeProduto" class="block mt-1 w-full" type="text" name="nomeProduto" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="categoria" class="block mt-1 w-full" type="text" name="categoria" />
